...
<table class="wc_status_table widefat" cellspacing="0" id="system_setting_status">
	...
	<tr>
		...
		<td><?php echo ( ( $welcart_information['subimage_rule'] ) ? __( "apply the new rule<br />(Tow underscores between the Product Code and serial number)", 'usces' ) : __( "not apply the new rule<br />(Truncation Product Code)", 'usces' ) ); // phpcs:ignore ?></td>
	</tr>
	<tr>
